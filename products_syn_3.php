...
Line / Feeder Protection System -->
<!DOCTYPE html>
<html class="scroll-smooth" lang="en">
<head>
    <meta charset="utf-8" />
    <meta content="width=device-width, initial-scale=1.0" name="viewport" />
    <title>Line / Feeder Protection System | Amtech Power Limited</title>
    <meta name="description" content="Line / Feeder Protection System details - Amtech Power Limited">
    ...
    <div class="grid md:grid-cols-12 gap-8">
        ...
        <div class="md:col-span-4">
            <div class="sticky top-28 bg-white dark:bg-surface-container-low border rounded-lg p-3 shadow-sm">
                <img src="../Amtech_Power_Redesign/assets/syn_img3.png"
        ...
        <div class="md:col-span-8 space-y-6 text-sm md:text-base text-on-surface-variant">
            ...
            <div class="bg-white dark:bg-surface-container-low p-6 rounded-lg border">
                <p>
                    The main protection in this application is the distance protection function with Three phase instantaneous over current protection , Three phase time over current protection, Directional Over Current Protection, Negative sequence over current protection, Over / Under Voltage Protection, Over / Under Frequency Protection , Fuse Failure, forward or reverse power protection, breaker monitoring and control, sequenceof- events recording, fault reporting, rate-of-change frequency. The system having Communication Protocols IEC61850, Modbus, Rear Ethernet.
...
<div class="mt-10 bg-white dark:bg-surface-container-low p-6 rounded-lg border">
   ...
   <ul class="space-y-2 text-sm md:text-base text-on-surface-variant list-disc pl-5">
    ...
    <li>Directional over current protection - 67</li>
    <li>Breaker failure protection - 50BF</li>
    <li>Transformer Differential Protection - 87</li>
    <li>Under voltage protection - 27</li>
    <li>Over voltage protection - 59</li>
    <li>Negative sequence over current protection - 47</li>
    <li>Loss of sensing voltage protection - 60FL</li>
