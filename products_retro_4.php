...
Crowbar Circuit for Linear Field Discharge & Field Overvoltage
 -->
<!DOCTYPE html>
...
<head>
    ...
    <title>Crowbar Circuit for Linear Field Discharge & Field Overvoltage | Amtech Power Limited</title>
    <meta name="description" content="Crowbar Circuit for Linear Field Discharge & Field Overvoltage details - Amtech Power Limited">
...
<article class="bg-surface-container p-10 rounded-lg shadow-lg border border-outline-variant/30">
    ...
    <!-- TITLE -->
      <h1 class="text-2xl font-headline-md text-primary dark:text-primary-fixed-dim mb-4">Customized and Retrofit Solution as per Available Space</h1>
    <h1 class="text-2xl md:text-3xl font-bold text-primary dark:text-primary-fixed-dim mb-8">
        Crowbar Circuit for Linear Field Discharge & Field Overvoltage
    </h1>
    ...
    <div class="grid md:grid-cols-12 gap-8">
        ...
        <!-- IMAGE PANEL (STRONG VISUAL BLOCK) -->
        <div class="md:col-span-4">
            <div class="sticky top-28 bg-white dark:bg-surface-container-low border border-outline-variant/30 rounded-lg p-3 shadow-sm">
                <img src="../Amtech_Power_Redesign/assets/retro_4.png"
                     alt="Crowbar Circuit for Linear Field Discharge & Field Overvoltage"
                     class="w-full h-auto object-contain rounded-md">
            </div>
        </div>

        <!-- CONTENT PANEL -->
        <div class="md:col-span-8 space-y-8 text-sm md:text-base text-on-surface-variant dark:text-inverse-on-surface/80">
            ...
            <!-- CONTENT BLOCKS (CLEAN FLOW, NOT BOXY) -->
    ...
    <h3 class="text-primary font-semibold mb-6">
    ...
    <div class="grid sm:grid-cols-2 gap-4">
        ...
        <!-- Card 1 -->
        <div class="flex gap-3 p-4 rounded-lg border bg-primary/5 dark:bg-primary-fixed-dim/10">
        ...
        <div class="flex gap-3 p-4 rounded-lg border bg-primary/5 dark:bg-primary-fixed-dim/10">
            ...
            <p class="text-sm md:text-base text-on-surface-variant">
                No maintenance required in Crowbar, unlike DC Field breaker which requires regular mechanical maintenance.
            </p>
        </div>
        ...
        <div class="flex gap-3 p-4 rounded-lg border bg-primary/5 dark:bg-primary-fixed-dim/10">
            ...
            <p class="text-sm md:text-base text-on-surface-variant">
                Mechanical wear & tear reduces life of DC Field breaker over time.
            </p>
        </div>

        <!-- Card 5 -->
        <div class="flex gap-3 p-4 rounded-lg border bg-primary/5 dark:bg-primary-fixed-dim/10 sm:col-span-2">
            <span class="material-symbols-outlined text-primary">
                public
            </span>
            <p class="text-sm md:text-base text-on-surface-variant">
                DC Field breaker is not manufactured in India and depends on external supply, while Crowbar is Amtech’s proprietary system made in India with faster support and availability.
            </p>
        </div>
        ...
        <div class="flex gap-3 p-4 rounded-lg border bg-primary/5 dark:bg-primary-fixed-dim/10 sm:col-span-2">
            ...
            <p class="text-sm md:text-base text-on-surface-variant">
                Crowbar circuit reduces overall system cost and size significantly.
            </p>
        </div>
