...
<head>
    ...
    <title>Unit Control Desk | Amtech Power Limited</title>
    <meta name="description" content="Unit Control Desk details - Amtech Power Limited">
    ...
    <div class="grid md:grid-cols-12 gap-8">
        ...
        <div class="md:col-span-4">
            <div class="sticky top-28 bg-white dark:bg-surface-container-low border rounded-lg p-3 shadow-sm">
                <img src="../Amtech_Power_Redesign/assets/syn_img7.png"
                     alt="Unit Control Desk"
        ...
        <div class="md:col-span-8 space-y-6 text-sm md:text-base text-on-surface-variant">
            ...
            <div class="bg-white dark:bg-surface-container-low p-6 rounded-lg border">
                <p>
                    We are providing customized Generator Control and Monitoring System. Here AVR, GOVERNOR, PROTECTION, Breakers and all necessary commands are remotely extended up to CRP Systems. Operations becames easier with help of this system. It will be totally customized system; can be designed as per the customer requirements and needs.
