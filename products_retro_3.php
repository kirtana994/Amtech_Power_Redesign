...
Analog & Digital Firing Boards -->
<!DOCTYPE html>
<html class="scroll-smooth" lang="en">
<head>
    <meta charset="utf-8" />
    <meta content="width=device-width, initial-scale=1.0" name="viewport" />
    <title>Analog & Digital Firing Boards | Amtech Power Limited</title>
    <meta name="description" content="Analog & Digital Firing Boards details - Amtech Power Limited">
...
<article class="bg-surface-container p-10 rounded-lg shadow-lg border border-outline-variant/30">
    ...
    <!-- ANALOG -->
    <div class="bg-white dark:bg-surface-container-low border rounded-lg p-3 shadow-sm">
        <h3 class="text-sm font-semibold text-primary mb-2">
            Analog Firing Board
        </h3>
        <img src="../Amtech_Power_Redesign/assets/retro_3_1.png"
             alt="Analog Firing Board"
    ...
    <div class=" bg-white dark:bg-surface-container-low border rounded-lg p-3 shadow-sm">
        <h3 class="text-sm font-semibold text-primary mb-2">
            Digital Firing Board
        </h3>
        <img src="../Amtech_Power_Redesign/assets/retro_3_2.png"
             alt="Digital Firing Board"
             class="w-full h-auto object-contain rounded-md">
    </div>
        ...
        <div class="md:col-span-8 space-y-6 text-sm md:text-base text-on-surface-variant">
            ...
            <div class="bg-white dark:bg-surface-container-low p-6 rounded-lg border">
                <p>
                    It uses 32-bit High-Performance Digital Signal Processor. The control board generates the necessary firing pulses for all 6 Thyristors. It accepts various inputs from different control circuits, line voltages and digital operation System (LCD keypad) to generate the necessary control and firing signals.

            </div>
            <div class="bg-white dark:bg-surface-container-low p-6 rounded-lg border">
                <p>
                    We are also manufacturing Analog Customized firing card on request.
                </p>
            </div>
