...
<head>
    ...
    <title>Customized and Retrofit solution as per Available Space | Amtech Power Limited</title>
    <meta name="description" content="Customized and Retrofit solution as per Available Space details - Amtech Power Limited">
    ...
    <div class="grid md:grid-cols-12 gap-8">
        ...
        <div class="md:col-span-4">
            <div class="sticky top-28 bg-white dark:bg-surface-container-low border rounded-lg p-3 shadow-sm">
                <img src="../Amtech_Power_Redesign/assets/retro_2.png"
                     alt="Customized and Retrofit solution as per Available Space"
        ...
        <div class="md:col-span-8 space-y-6 text-sm md:text-base text-on-surface-variant">
            ...
            <div class="bg-white dark:bg-surface-container-low p-6 rounded-lg border">
                <p>
                    Amtech is solution provider, if customer has space constraint, we can provide solution as per the available space. We have provision for customized System, like front & back access, only front access, wall mounted System or machine mounted etc…
                </p>
            </div>
