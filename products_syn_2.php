...
<head>
    ...
    <title>Transformer Protection System | Amtech Power Limited</title>
    <meta name="description" content="Transformer Protection System details - Amtech Power Limited">
    ...
    <div class="grid md:grid-cols-12 gap-8">
        ...
        <div class="md:col-span-4">
            <div class="sticky top-28 bg-white dark:bg-surface-container-low border rounded-lg p-3 shadow-sm">
                <img src="../Amtech_Power_Redesign/assets/syn_img2.png"
        ...
        <div class="md:col-span-8 space-y-6 text-sm md:text-base text-on-surface-variant">
            ...
            <div class="bg-white dark:bg-surface-container-low p-6 rounded-lg border">
                <p>
                    The multifunction numeric relay that provides differential protection, over current, Instantaneous over current, restricted earth fault, zero sequence earth fault current, negative sequence over current, breaker failure and over/under voltage protection. Facility to synchronize relay time from SCADA, monitoring and control, sequence-of-events recording, fault reporting. The system having Communication Protocols IEC61850, Modbus, Rear Ethernet.
