...
<head>
    ...
    <title>1 Auto and 1 Manual Digital Excitation System | Amtech Power Limited</title>
    <meta name="description" content="1 Auto and 1 Manual Digital Excitation System details - Amtech Power Limited">
...
<article class="bg-surface-container p-10 rounded-lg shadow-lg border border-outline-variant/30">
    ...
    <div class="grid md:grid-cols-12 gap-8">
        ...
        <div class="md:col-span-8 space-y-8 text-sm md:text-base text-on-surface-variant dark:text-inverse-on-surface/80">
            ...
            <!-- OPERATING MODES (SECTION HEADER STYLE) -->
            <div>
                <h2 class="text-primary font-semibold mb-3">Operating Modes</h2>
                <p>1. Solo mode</p>
