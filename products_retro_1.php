...
<head>
    ...
    <title>Mounting Plates | Amtech Power Limited</title>
    <meta name="description" content="Mounting Plates details - Amtech Power Limited">
    ...
    <div class="grid md:grid-cols-12 gap-8">
        ...
        <div class="md:col-span-4">
            <div class="sticky top-28 bg-white dark:bg-surface-container-low border rounded-lg p-3 shadow-sm">
                <img src="../Amtech_Power_Redesign/assets/retro_1.png"
        ...
        <div class="md:col-span-8 space-y-6 text-sm md:text-base text-on-surface-variant">
            ...
            <div class="bg-white dark:bg-surface-container-low p-6 rounded-lg border">
                <p>
                    Excitation mounting plate is the customized solution in the Power Generation industry. This mounting plate provides full-featured excitation system clubbed with necessary functionality and reliable operation of brush-less synchronous generator. Amtech engineered quality solutions are ready for installation in your new or existing cubicle.
                </p>
            </div>
            <div class="bg-white dark:bg-surface-container-low p-6 rounded-lg border">
                <p>
                    Compactness , convenience and performance are key words for new installations and are essential when replacement of original aging excitation systems becomes necessary.
            </div>
            <div class="bg-white dark:bg-surface-container-low p-6 rounded-lg border">
                <p>
                    This excitation system designs to perfectly fit all your synchronous motor, steam turbine, gas turbine, diesel and Hydro generating systems.These retrofit solutions include all the functionality of your old system and are assembled on mounting plate with pin to pin replacement with existing system.
                </p>
            </div>
