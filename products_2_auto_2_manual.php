...
<head>
    ...
    <title>2 Auto and 2 Manual Digital Excitation System | Amtech Power Limited</title>
    <meta name="description" content="2 Auto and 2 Manual Digital Excitation System details - Amtech Power Limited">
...
<body class="bg-surface dark:bg-inverse-surface text-on-surface dark:text-inverse-on-surface font-body-md antialiased selection:bg-primary-container selection:text-white transition-colors duration-300">
    ...
    <main class="pt-28 max-w-5xl mx-auto px-6">

<article class="bg-surface-container p-8 md:p-10 rounded-lg shadow-lg border border-outline-variant/30">
    ...
    <h1 class="text-2xl md:text-3xl font-bold text-primary dark:text-primary-fixed-dim mb-6">
    ...
    <div class="grid md:grid-cols-[260px_1fr] gap-6 items-start">
        ...
        <!-- LEFT IMAGE COLUMN (STICKS, NO OVERLAP) -->
        <div class="md:sticky md:top-28">
            <div class="rounded-lg overflow-hidden border border-outline-variant/30 bg-white dark:bg-surface-container-low p-2">
                <img src="../Amtech_Power_Redesign/assets/1_auto_1_manual.png"
                     alt="Excitation System"
                     class="w-full h-auto object-contain rounded-md">
            </div>
        </div>

        <!-- RIGHT CONTENT COLUMN -->
        <div class="space-y-6 text-sm md:text-base text-on-surface-variant dark:text-inverse-on-surface/80">

            <!-- INTRO -->
            <div class="bg-white dark:bg-surface-container-low p-5 rounded-lg border">
                <p>
            ...
            <!-- MODES -->
            <div class="bg-primary/5 dark:bg-primary-fixed-dim/10 p-5 rounded-lg border border-primary/20">
                <p class="font-semibold text-primary dark:text-primary-fixed-dim mb-2">
                    The Digital Excitation Control System provides necessary controls and protection to operate the Generator in
                </p>
                <p>1. Solo mode</p>
                <p>2. Parallel with other generators (Droop Mode)</p>
                <p>3. Parallel with the grid (PF or VAR Mode)</p>
            </div>

            <!-- BOXES -->
            <div class="bg-white dark:bg-surface-container-low p-5 rounded-lg border">
                <p>
                    The 15/ 20 Amp Excitation system which has multiple control functions. The digital AVR has a soft start feature with a user-adjustable setting to govern the rate at which the generator voltage is allowed to buildup. The output voltage of AC generator is maintained at the set point by controlling the exciter field current.
                </p>
            </div>

            <div class="bg-white dark:bg-surface-container-low p-5 rounded-lg border">
                <p>
                    The Digital Excitation system has got one auto and one manual mode i.e. Field Current Regulator mode (FCR mode). This FCR mode will be useful at the time of commissioning and when the Auto mode operation develops problem.
                </p>
            </div>
            ...
            <div class="bg-white dark:bg-surface-container-low p-5 rounded-lg border">
                <p>
                    Extreme conditions of operation or fault conditions are latched with a Hooter alarm to help the user to identify the cause for tripping of the excitation system. The parameters are also viewable via the front System LCD of the AVR unit. Password protection offers the restrict access for changing the parameter setting. The oscillographic data recording feature can be used to record the generator voltage, current, frequency, kW, Power Factor, exciter field voltage and exciter field current.
                </p>
            </div>
