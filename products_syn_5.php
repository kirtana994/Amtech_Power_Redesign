...
Synchronization and Load Sharing system
 -->
<!DOCTYPE html>
...
<head>
    ...
    <title>Synchronization and Load Sharing System | Amtech Power Limited</title>
    <meta name="description" content="Synchronization and Load Sharing System details - Amtech Power Limited">
    ...
    <div class="grid md:grid-cols-12 gap-8">
        ...
        <div class="md:col-span-4">
            <div class="sticky top-28 bg-white dark:bg-surface-container-low border rounded-lg p-3 shadow-sm">
                <img src="../Amtech_Power_Redesign/assets/syn_img5.png"
                     alt="Synchronization and Load Sharing System"
        ...
        <div class="md:col-span-8 space-y-6 text-sm md:text-base text-on-surface-variant">
            ...
            <div class="bg-white dark:bg-surface-container-low p-6 rounded-lg border">
                <p>
                    Synchronization and Load Sharing System having feature of Manual Synchronization, Auto Synchronization with selection option of Synchronization with different machine and Grid and Load Sharing system between machines.
