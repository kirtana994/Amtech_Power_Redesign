...
<head>
    ...
    <title>Digital Governor System | Amtech Power Limited</title>
    <meta name="description" content="Digital Governor System details - Amtech Power Limited">
    ...
    <div class="grid md:grid-cols-12 gap-8">
        ...
        <div class="md:col-span-4">
            <div class="sticky top-28 bg-white dark:bg-surface-container-low border rounded-lg p-3 shadow-sm">
                <img src="../Amtech_Power_Redesign/assets/syn_img6.png"
                     alt="Digital Governor System"
        ...
        <div class="md:col-span-8 space-y-6 text-sm md:text-base text-on-surface-variant">
            ...
            <div class="bg-white dark:bg-surface-container-low p-6 rounded-lg border">
                <p>
                    Amtech has expertise in the field of Digital Governor System. We can provide STG governor as well as Hydro Governor with customized solution.
