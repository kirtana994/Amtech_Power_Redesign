...
<head>
    ...
    <title>Turbine Control and Monitoring System | Amtech Power Limited</title>
    <meta name="description" content="Turbine Control and Monitoring System details - Amtech Power Limited">
    ...
    <div class="grid md:grid-cols-12 gap-8">
        ...
        <div class="md:col-span-4">
            <div class="sticky top-28 bg-white dark:bg-surface-container-low border rounded-lg p-3 shadow-sm">
                <img src="../Amtech_Power_Redesign/assets/syn_img4.png"
                     alt="Turbine Control and Monitoring System"
        ...
        <div class="md:col-span-8 space-y-6 text-sm md:text-base text-on-surface-variant">
            ...
            <div class="bg-white dark:bg-surface-container-low p-6 rounded-lg border">
                <p>
                    Amtech is also serving in the field of plant instrumentation in power plant. We are supplier for various types of turbine control and monitoring system, for measurement of temperature / pressure, water / oil level, coolant level etc...
