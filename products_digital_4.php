...
//2 Auto and 2 Manual Digital Excitation System ranges above 2500Adc
<!DOCTYPE html>
<html class="scroll-smooth" lang="en">
<head>
    <meta charset="utf-8" />
    <meta content="width=device-width, initial-scale=1.0" name="viewport" />
    <title>2 Auto and 2 Manual Digital Excitation System ranges above 2500Adc | Amtech Power Limited</title>
    <meta name="description" content="2 Auto and 2 Manual Digital Excitation System ranges above 2500Adc details - Amtech Power Limited">
    ...
    <div class="grid md:grid-cols-12 gap-8">
        ...
        <div class="md:col-span-4">
            <div class="sticky top-28 bg-white dark:bg-surface-container-low border border-outline-variant/30 rounded-lg p-3">
                ...
                <img src="../Amtech_Power_Redesign/assets/digital_img_4.png"
