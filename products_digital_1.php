//Digital Static Excitation & Control system for 500KW to 200MW Synchronous Machine

//1 Auto and 1 Manual Digital Excitation System ranges from 20Adc to 2500Adc
<!DOCTYPE html>
<html class="scroll-smooth" lang="en">
<head>
    <meta charset="utf-8" />
    <meta content="width=device-width, initial-scale=1.0" name="viewport" />
    <title>1 Auto and 1 Manual Digital Excitation System ranges from 20Adc to 2500Adc | Amtech Power Limited</title>
    <meta name="description" content="1 Auto and 1 Manual Digital Excitation System ranges from 20Adc to 2500Adc details - Amtech Power Limited">
...
<article class="bg-surface-container p-8 md:p-10 rounded-lg shadow-lg border border-outline-variant/30">
    ...
    <!-- TITLE -->
      <h1 class="text-2xl font-headline-md text-primary dark:text-primary-fixed-dim mb-4">Digital Static Excitation & Control system for 500KW to 200MW SynchronousMachine</h1>
    <h1 class="text-2xl md:text-3xl font-bold text-primary dark:text-primary-fixed-dim mb-2">
        1 Auto and 1 Manual Digital Excitation System ranges from 20Adc to 2500Adc
    </h1>

    <p class="text-sm md:text-base text-on-surface-variant dark:text-inverse-on-surface/70 mb-6">
        Digital Static Excitation System (Rotary)
    </p>
    ...
    <div class="grid md:grid-cols-12 gap-8">
        ...
        <div class="md:col-span-4">
            <div class="sticky top-28 bg-white dark:bg-surface-container-low border border-outline-variant/30 rounded-lg p-3">
                
                <img src="../Amtech_Power_Redesign/assets/digital_img_1.png"
                     class="w-full h-auto object-contain rounded-md"
                     alt="Digital Static Excitation System">

                <p class="text-xs text-center mt-2 text-on-surface-variant dark:text-inverse-on-surface/60">
        ...
        <!-- CONTENT -->
        <div class="md:col-span-8 space-y-6 text-sm md:text-base text-on-surface-variant dark:text-inverse-on-surface/80">
            ...
            <!-- DIGITAL FIRING CARD -->
            <div class="bg-primary/5 dark:bg-primary-fixed-dim/10 p-6 rounded-lg border border-primary/20">
                <h3 class="font-semibold text-primary mb-2">Digital Firing Card</h3>
            ...
            <!-- THYRISTOR STACK -->
            <div class="bg-white dark:bg-surface-container-low p-6 rounded-lg border">
                <h3 class="font-semibold text-primary mb-2">Thyristors Stack</h3>
            ...
            <!-- CROWBAR SECTION -->
            <div class="bg-white dark:bg-surface-container-low p-6 rounded-lg border">
                <h3 class="font-semibold text-primary mb-2">Crowbar Operations</h3>
