...
<head>
    ...
    <title>Thyristor Rectifier Bridge | Amtech Power Limited</title>
    <meta name="description" content="Thyristor Rectifier Bridge details - Amtech Power Limited">
...
<article class="bg-surface-container p-10 rounded-lg shadow-lg border border-outline-variant/30">
    ...
    <h2 class="text-xl md:text-2xl font-semibold text-on-secondary-container mb-8">
        Thyristor Rectifier Bridge
    </h2>
    ...
    <div class="grid md:grid-cols-12 gap-8">
        ...
        <div class="md:col-span-4">
            <div class="sticky top-28 bg-white dark:bg-surface-container-low border rounded-lg p-3 shadow-sm">
                <img src="../Amtech_Power_Redesign/assets/retro_5.png"
                     alt="Thyristor Rectifier Bridge"
        ...
        <div class="md:col-span-8 space-y-6 text-sm md:text-base text-on-surface-variant">
            ...
            <div class="bg-white dark:bg-surface-container-low p-6 rounded-lg border">
                <p>
                    "AXPERT Opti-Power" Three phase full wave controlled bridge rectifier is a modern Digital Signal Processor based highly functional bridge rectifier that is easy to use. Six thyristors are used in full wave controlled rectifier. The control board uses 32-bit High-Performance Digital Signal Processor and generates the necessary gate pulses for bridge rectifier operation. It accepts various inputs from different controller and Digital Operation Panel (LCD Keypad Module Optional) to generate the necessary control and gate signals. The unit is equipped with Digital Operation Panel (LCD Keypad Module Optional) for the user interface.
                </p>
            </div>

            <!-- OUTPUT RANGE -->
            <div class="bg-primary/5 p-6 rounded-lg border border-primary/20">
                <h3 class="font-semibold text-primary mb-2">Output Current Range</h3>
                <p>10 to 10,000 Amp</p>
            </div>

            <!-- FEATURES -->
            <div class="bg-white dark:bg-surface-container-low p-6 rounded-lg border">
                <h3 class="font-semibold text-primary mb-4">Features</h3>
                <ul class="space-y-2 list-disc pl-5">
                    <li>Three Control Modes: Keypad (Optional), Terminal and Serial</li>
                    <li>Self diagnostics facility</li>
                    <li>Built-in PID</li>
                    <li>Parameter monitoring on single screen (Optional)</li>
                    <li>Easy parameter navigation through MODE, NORM, GROUP, UP and DOWN keys</li>
                    <li>3-status LEDs for RUN, STOP and FAULT</li>
                    <li>RS-485 Modbus communication as standard</li>
                    <li>8 Programmable Digital Inputs (Sink & Source logic)</li>
                    <li>4 Programmable Digital Outputs (Open Collector Type)</li>
                    <li>3 Programmable Digital Outputs (Potential Free Contact)</li>
                    <li>4 Programmable Analog Inputs (0–10V and 4–20mA)</li>
                    <li>4 Programmable Analog Outputs (0–10V and 4–20mA)</li>
                </ul>
            </div>

            <!-- PROTECTION + APPLICATIONS GRID -->
<div class="grid md:grid-cols-2 gap-6 mt-8">
    ...
    <div class="bg-primary/5 p-6 rounded-lg border border-primary/20">
        ...
        <div class="flex items-center gap-3 mb-4">
            ...
            <h3 class="font-semibold text-primary">Protection</h3>
        </div>

        <ul class="space-y-2 text-sm md:text-base text-on-surface-variant">
    ...
    <div class="bg-primary/5 p-6 rounded-lg border border-primary/20">
        ...
        <div class="flex items-center gap-3 mb-4">
            ...
            <h3 class="font-semibold text-primary">Applications</h3>
        </div>
