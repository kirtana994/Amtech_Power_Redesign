...
<head>
    ...
    <title>Compact Excitation System | Amtech Power Limited</title>
    <meta name="description" content="Compact Excitation System details - Amtech Power Limited">
...
<body class="bg-surface dark:bg-inverse-surface text-on-surface dark:text-inverse-on-surface font-body-md antialiased selection:bg-primary-container selection:text-white transition-colors duration-300">
    ...
    <main class="pt-28 max-w-[900px] mx-auto px-6">
        <article class="bg-surface-container p-8 rounded-sm shadow-sm border border-outline-variant/30">
            <h1 class="text-2xl font-headline-md text-primary dark:text-primary-fixed-dim mb-4">Brush-less Digital Excitation &amp; Control system for 500KW to 60MW</h1>
            <h2 class="font-semibold text-on-secondary-container dark:text-white mb-5">Compact Excitation System for 5MW or Below Synchronous Machines</h2>

            <div class="flex flex-col md:flex-row md:items-start gap-6 mb-6">
                <div class="w-full md:w-72 lg:w-80 shrink-0">
                    <a href="../Amtech_Power_Redesign/assets/Compact-Excitation-System-for-5MW-or-Below-Synchronous-Machines.png" target="_blank" rel="noopener noreferrer">
                        <img alt="Compact Excitation (Below 5MW)" src="https://amtechpower.in/images/product_large/Below-5mw.jpg" class="w-full h-auto object-contain rounded-sm border border-outline-variant/30 bg-white dark:bg-surface-container-low p-3" />
                    </a>

                </div>

                <div class="flex-1">
                    <p class="text-sm md:text-base leading-relaxed text-on-surface-variant dark:text-inverse-on-surface/80">
                        Amtech offers a high powered, low-cost digital excitation control system. This environmentally rugged product is ideally suited for controlling the output of brush-less excited synchronous generators up to 5MW. This has a very impressive 7Adc output from a pulse width modulated power stage. It is perfect for machines that will be paralleled to other generators and/or to the utility system. It is ideal for distributed generation, co-generation and peak shaving applications. It is easy to use, and it has communications capability with a PC. It utilizes microprocessor technology and control algorithms pioneered by us for longer than a decade. It shares many features and functions of our larger excitation control systems. It is fifth generation of microprocessor-based excitation system.
                    </p>
                </div>
            </div>

            <div class="mb-4">
                <p class="font-semibold dark:text-primary">Highlights</p>
                <ul class="list-disc ml-5 mt-2 space-y-1 text-sm dark:text-white">
                    <li>Microprocessor based</li>
                    <li>0.25% Voltage Regulation Accuracy</li>
                    <li>0.5% accuracy up to 40% THD</li>
                    <li>63Vdc @ 7Adc PWM output</li>
                    <li>0-3X V/Hz limiting</li>
                    <li>Soft Start capability</li>
                    <li>20 standard stability selections and one customizable selection</li>
                    <li>VAR/PF control</li>
                    <li>Over/Under excitation limiting</li>
                    <li>Voltage Matching and Manual Mode</li>
                    <li>Paralleling input from 1 or 5A CT secondary</li>
                    <li>Nominal sensing inputs: 120, 240, 480 and 600Vac</li>
                    <li>Power Input from 50/60Hz shunt connections or PMGs (50–400Hz)</li>
                    <li>Five generator protection functions including Loss of Sensing transfer to manual</li>
                    <li>Alarm Contact Output, accessory input, PC setup</li>
                    <li>CURus recognition per UL 508 and CSA C22.2 No. 14; DNV 2.4; CE compliant</li>
                </ul>
            </div>

            <div class="mt-6">
                <a class="inline-block bg-primary text-on-primary px-6 py-2 rounded-md" href="products.php">Back to Products</a>
            </div>
        </article>
    </main>
